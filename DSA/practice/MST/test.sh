...
g++ -std=c++17 2305006_kruskal.cpp -o kruskal_solution
...
g++ -std=c++17 2305006_Prim.cpp -o prims_solution
...
rm -f temp_output.txt my_edges.txt expected_edges.txt kruskal_solution prims_solution what is this